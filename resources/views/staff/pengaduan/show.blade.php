    ...
    <div class="card-body">
        ...
        <div style="margin-bottom: 30px;">
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="padding: 8px;">: {{ $pengaduan->user->name }} ({{ $pengaduan->user->email }})</td>
                </tr>
                <tr>
                    <td style="padding: 8px; font-weight: bold;">Kategori</td>
                    <td style="padding: 8px;">: {{ $pengaduan->category->nama_kategori }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 8px;">
                        @if($pengaduan->status == 'pending')
                            <span style="background: #ffc107; color: white; padding: 5px 15px; border-radius: 4px;">⏳ Menunggu</span>
                        @elseif($pengaduan->status == 'proses')
                            <span style="background: #17a2b8; color: white; padding: 5px 15px; border-radius: 4px;">⚙️ Diproses</span>
                        @elseif($pengaduan->status == 'selesai')
                            <span style="background: #28a745; color: white; padding: 5px 15px; border-radius: 4px;">✅ Selesai</span>
                        @else
                            <span style="background: #dc3545; color: white; padding: 5px 15px; border-radius: 4px;">❌ Ditolak</span>
                        @endif
                    </td>
                </tr>
            </table>
        ...
        <div style="margin-bottom: 30px;">
            ...
            <div style="background: #f8f9fa; padding: 15px; border-radius: 4px; margin-top: 10px;">
                ...
                <p style="margin-top: 10px; white-space: pre-wrap;">{{ $pengaduan->isi_laporan }}</p>
            </div>
        </div>
        ...
        @if($pengaduan->foto)
            <div style="margin-bottom: 30px;">
                ...
                <img src="{{ asset('storage/' . $pengaduan->foto) }}" alt="Foto Pengaduan" style="max-width: 500px; border-radius: 8px; margin-top: 10px;">
            </div>
        @endif
        ...
        @if($pengaduan->tanggapan)
            <div style="margin-bottom: 30px; background: #e7f3ff; padding: 20px; border-radius: 8px;">
                ...
                <p><strong>Ditanggapi oleh:</strong> {{ $pengaduan->staff->user->name ?? 'Staff' }}</p>
                <p><strong>Tanggal:</strong> {{ $pengaduan->tanggal_tanggapan->format('d F Y, H:i') }} WIB</p>
            ...
            <div style="background: #fff3cd; padding: 20px; border-radius: 8px;">
                ...
                <form action="{{ route('staff.pengaduan.balas', $pengaduan->id) }}" method="POST" style="margin-top: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="tanggapan" class="form-control" rows="5" required placeholder="Tuliskan tanggapan Anda terhadap pengaduan ini...">{{ old('tanggapan') }}</textarea>
